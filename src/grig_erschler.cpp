...
grig01::grig01(grig01::nonce, char c) : m_data{c} {}
grig01::grig01() : m_data{'1'} {}

grig01::grig01(std::string word) : grig01() {
...
const grig01//
    grig01::a(grig01::nonce{}, 'a'), //
    grig01::b(grig01::nonce{}, 'b'), //
    grig01::c(grig01::nonce{}, 'c'), //
    grig01::d(grig01::nonce{}, 'd');

const std::vector<char>& grig01::portrait() const {
  return m_data;
}

grig01 grig01::inverse() const {
  grig01 result;
  inverse_portrait(result.m_data, m_data);
  return result;
}

grig01& grig01::operator*=(const grig01& rhs) {
  auto tmp = operator*(rhs);
  *this = std::move(tmp);
  return *this;
}

grig01 grig01::operator*(const grig01& rhs) const {
  grig01 result;
...
bool grig01::multiply_portraits(std::vector<char>& output, const std::vector<char>& lhs, const std::vector<char>& rhs) {
  output.clear();
...
bool grig01::inverse_portrait(std::vector<char>& output, const std::vector<char>& in) {
  output.clear();
